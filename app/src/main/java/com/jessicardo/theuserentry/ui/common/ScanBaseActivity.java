...
import com.jessicardo.theuserentry.util.googlebarcodescanner.camera.CameraSource;
 ...
 * @author Jesse A.
 */
public abstract class ScanBaseActivity extends AbstractBaseActivity {
    ...
    public static final String PARAMS_AUTO_FOCUS = "PARAMS_AUTO_FOCUS";

    public static final String PARAMS_USE_FLASH = "PARAMS_USE_FLASH";
    ...
    /**
     * Must call to setup camera Initializes the UI and creates the detector pipeline.
     */
    ...
    private void registerSensorListener() {
        mSensorManager.registerListener(
                mSensorEventListener, mLightSensor, SensorManager.SENSOR_DELAY_UI);
    }
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(getGraphicOverlay(), R.string.permission_camera_rationale,
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        BarcodeTrackerFactory barcodeFactory = new BarcodeTrackerFactory(getGraphicOverlay(),
                getBarcodeDetectedListener());
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            boolean autoFocus = getIntent().getBooleanExtra(PARAMS_AUTO_FOCUS, false);
            boolean useFlash = getIntent().getBooleanExtra(PARAMS_USE_FLASH, false);
            createCameraSource(autoFocus, useFlash);
            return;
        }
    ...
    protected void startCameraSource() throws SecurityException {
        ...
        if (mCameraSource != null) {
            try {
                getPreview().start(mCameraSource, getGraphicOverlay());
            } catch (IOException e) {
    ...
    private class ScaleListener implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        /**
         * Responds to the end of a scale gesture. Reported by existing pointers going up. <p/> Once
         * a scale has ended, {@link ScaleGestureDetector#getFocusX()} and {@link
    ...
    protected void toggleTorchFlag() {
        mTapped = true;
        toggleTorchFlag(true);
    }

    protected void toggleTorchFlag(boolean tapped) {
    ...
    protected boolean isTorchOn() {
        return mCameraSource.getFlashMode().equalsIgnoreCase(Camera.Parameters.FLASH_MODE_TORCH);
    }

    protected abstract ImageView getTorchButton();
    ...
    protected abstract BarcodeDetectedListener getBarcodeDetectedListener();

    protected abstract CameraSourcePreview getPreview();

    protected abstract GraphicOverlay<BarcodeGraphic> getGraphicOverlay();
}
