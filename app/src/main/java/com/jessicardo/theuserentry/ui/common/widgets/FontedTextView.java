...
/**
 * Text view that auto adjusts text size to fit within the view. If the text size equals the minimum
 * text size and still does not fit, append with an ellipsis.
 */
public class FontedTextView extends AppCompatTextView {

    private static final String TAG = FontedTextView.class.getSimpleName();
                ...
                // Otherwise, trim to the previous line and add an ellipsis
                    ...
                    try {
                        ...
                        while (width < lineWidth + ellipseWidth) {
                            lineWidth = textPaint
                                    .measureText(text.subSequence(start, --end + 1).toString());
                        }

                        setText(text.subSequence(0, end) + mEllipsis);
                    } catch (Exception e) {
                        Log.e(TAG, "exception caught resizing, e:" + e, e);
                    }
